  ...
  return (
    <>
      <aside
        ...
        style={{ backgroundColor: "#ffffff", position: "fixed", height: 1000 ,width:80}}
      >
        ...
        <ul className="menu-inner py-1">
          ...
          <li style={{width:90}} className={`menu-item ${activeItem == "Order" ? "active" : ""}`}>
          ...
          <li style={{width:90}}  className={`menu-item ${activeItem == "CheckOutPharmacist" ? "active" : ""}`}>
